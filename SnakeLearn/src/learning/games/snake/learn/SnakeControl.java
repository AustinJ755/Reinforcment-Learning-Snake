...
public class SnakeControl {
	...
	public static void toyAsyncNstep() throws IOException {
		...
		FXMLLoader loader = new FXMLLoader(SnakeControl.class.getResource("/fxml/LearningMonitor.fxml"));//(new File("C:\\Users\\aj755\\eclipse-workspace\\MineSweeperLearn\\src\\resources\\fxml\\LearningMonitor.fxml")).toURI().toURL());
